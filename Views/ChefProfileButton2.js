...
export default class ChefProfileButton2 extends React.Component {
      ...
      return (
        <TouchableOpacity onPress={() => this.ImageLoader()}>
          <Image
            ...
            style={styles.logLogo, [{ borderRadius: 1000, width: 0.40 * windowW, height: 0.40 * windowW, borderWidth:2, borderColor:'rgba(0,0,0,0.3)' }]} />
        </TouchableOpacity>
      )
    }
  }
