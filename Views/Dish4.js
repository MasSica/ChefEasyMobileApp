...
export default class Dish4 extends React.Component {
  constructor(props){
    super(props);
  ...
  get_image_from_db =async()=>{
    ...
    if (result.status===200){
      ...
      this.handleImage(data.dish4_image);
      ...
      return (
        <TouchableOpacity onPress={() => this.ImageLoader()}>
          <Image
            ...
            style={styles.logLogo, [{borderRadius:10, width:0.35*windowW ,height:0.35*windowW}]} />
        </TouchableOpacity>
      )
    }
  }
